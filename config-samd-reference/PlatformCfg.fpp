...
constant FW_MUTEX_HANDLE_MAX_SIZE = 8

@ Maximum size of a handle for Os::CountingSemaphore
constant FW_COUNTING_SEMAPHORE_HANDLE_MAX_SIZE = 8

@ Maximum size of a handle for Os::Queue
constant FW_QUEUE_HANDLE_MAX_SIZE = 144
...
constant FW_CONDITION_VARIABLE_HANDLE_MAX_SIZE = 8
